...
!-----------------------------------------------------------------------
!
      ELSE IF (itrc.ge.3 .AND. itrc.le.6) THEN
!      ELSE IF (itrc.eq.3) THEN
	DO j=JstrT,JendT
          DO i=IstrT,IendT
	     stflx(i,j,itrc)=0.0001_r8
#ifdef TL_IOMS
	  tl_stflx(i,j,itrc)=0.0_r8
#endif
          END DO
...
!      ELSE IF (itrc.ge.6 .AND. itrc.le.8) THEN
!      ELSE IF (itrc.eq.3) THEN
!	  DO j=JstrT,JendT
!          DO i=IstrT,IendT
...
!        END DO
      ...
      ELSE
        DO j=JstrT,JendT
          DO i=IstrT,IendT
            stflx(i,j,itrc)=0.0_r8
!	  IF (NT(ng).gt.4 .AND. NT(ng).le.9) THEN
!            stflx(i,j,itrc)=0.001_r8
!	  ELSE
!	  stflx(i,j,itrc)=0.0_r8
!	  END IF
#ifdef TL_IOMS
